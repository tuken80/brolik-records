...
@Component({
    selector: 'app-header-secondaire',
    templateUrl: './header-secondaire.component.html',
    styleUrls: [ './header-secondaire.component.css' ]
})
export class HeaderSecondaireComponent implements OnInit {
    titre = '';
